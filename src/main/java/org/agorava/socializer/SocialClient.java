...
public class SocialClient implements Serializable {
	...
	// return Maps.uniqueIndex(getSessions(), new Function<OAuthSession,
	// String>() {
	//
	// @Override
	...
	/**
	 * Returns the authorization url for the currently selected service
	 * 
	 * @return
	 * @throws IOException
	 */
	public String serviceInit() throws IOException {
		return manager.initNewSession(selectedService);
	}
